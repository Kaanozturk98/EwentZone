    ...
    <div className="bg-white">
      <div className="container mx-auto h-24 flex items-center justify-between">
        ...
        <nav className="flex gap-x-8 text-lg font-bold">
          <a
            href="#"
            className="text-opacity-90 text-gray-800 transition-all hover:text-red-900 hover:text-opacity-100"
          >
            Classes
          </a>
          ...
          <a
            href="#"
            className="text-gray-800 text-opacity-90 transition-all hover:text-red-900 hover:text-opacity-100"
          >
            Login
          </a>
        </nav>
